...
- 六種戰機（正常金銀銅與暗金暗銀暗銅）、四色武器、五關戰役（至少 10 分鐘有效戰鬥）
- 手機觸控與桌面鍵鼠皆可遊玩
...
- 全程自動開火，玩家專注移動走位。
- 開局選一架戰機：**金／暗金**（均衡靈活）、**銀／暗銀**（高傷薄甲，雷射起步）、**銅／暗銅**（重裝多炸彈）。暗色版本沿用原機性能，只改為較低亮度塗裝。
- 五關戰役，每關至少 120 秒；第 88 秒出首領，擊破才能前進；完整通關至少 10 分鐘。
- 擊落敵機掉四色武器：藍 P 散射、綠 L 穿透、紫 A 追蹤、金 N 爆裂；補給漂浮約 10 秒，同款拾取升級（最高 Lv.10）。
